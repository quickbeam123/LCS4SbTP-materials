...
(declare-lemma-predicate BC-AxEvol-eq-a-l14 (Nat Int) Bool)
(declare-lemma-predicate IC-AxEvol-eq-a-l14 (Nat Nat Int) Bool)
(declare-lemma-predicate Con-AxEvol-eq-a-l14 (Nat Nat Int) Bool)
(declare-lemma-predicate PremEvol-eq-a-l14 (Int Nat Nat) Bool)
(declare-lemma-predicate BC-AxEvol-leq-a-l14 (Nat Int) Bool)
(declare-lemma-predicate IC-AxEvol-leq-a-l14 (Nat Nat Int) Bool)
(declare-lemma-predicate Con-AxEvol-leq-a-l14 (Nat Nat Int) Bool)
(declare-lemma-predicate PremEvol-leq-a-l14 (Int Nat Nat) Bool)
(declare-lemma-predicate BC-AxEvol-geq-a-l14 (Nat Int) Bool)
(declare-lemma-predicate IC-AxEvol-geq-a-l14 (Nat Nat Int) Bool)
(declare-lemma-predicate Con-AxEvol-geq-a-l14 (Nat Nat Int) Bool)
(declare-lemma-predicate PremEvol-geq-a-l14 (Int Nat Nat) Bool)
...
; Definition: Premise for value-evolution-eq-a-l14
(assert
   (forall ((pos Int)(boundL Nat)(boundR Nat))
      (=
         (PremEvol-eq-a-l14 pos boundL boundR)
         (forall ((Itl14 Nat))
            (=>
               (and
                  (Sub boundL (s Itl14))
                  (Sub Itl14 boundR)
                  (= (a (l14 boundL) pos) (a (l14 Itl14) pos))
               )
               (= (a (l14 boundL) pos) (a (l14 (s Itl14)) pos))
            )
         )
      )
   )
...
; Axiom: already-proven-lemma value-evolution-eq-a-l14
(assert
   (forall ((pos Int)(boundL Nat)(boundR Nat))
      (=>
         (PremEvol-eq-a-l14 pos boundL boundR)
         (=>
            (Sub boundL (s boundR))
            (= (a (l14 boundL) pos) (a (l14 boundR) pos))
         )
      )
   )
)

; Definition: Premise for value-evolution-leq-a-l14
(assert
   (forall ((pos Int)(boundL Nat)(boundR Nat))
      (=
         (PremEvol-leq-a-l14 pos boundL boundR)
         (forall ((Itl14 Nat))
            (=>
               (and
                  (Sub boundL (s Itl14))
...
; Axiom: already-proven-lemma value-evolution-leq-a-l14
(assert
   (forall ((pos Int)(boundL Nat)(boundR Nat))
      (=>
         (PremEvol-leq-a-l14 pos boundL boundR)
...
; Definition: Premise for value-evolution-geq-a-l14
(assert
   (forall ((pos Int)(boundL Nat)(boundR Nat))
      (=
         (PremEvol-geq-a-l14 pos boundL boundR)
         (forall ((Itl14 Nat))
            (=>
               (and
                  (Sub boundL (s Itl14))
...
; Axiom: already-proven-lemma value-evolution-geq-a-l14
(assert
   (forall ((pos Int)(boundL Nat)(boundR Nat))
      (=>
         (PremEvol-geq-a-l14 pos boundL boundR)
